...
class AddInventoryPage extends AbstractPageWithBackgroundAndContent {
  AddInventoryPage() : super(
    title: TextString.page_title__add_drug,
      ...
      child: Container(
        ...
        child: ListView(
          children: [
            ...
            // -----
            FocusButton(height: ScreenUtil.heightInPercent(7), width: double.infinity, onTap: () {}, label: TextString.page_title__add_drug),
