...
class AddInventoryController extends AbstractController {
  ...
  void submit() async {
    ...
    var wrapper = await InventoryService.instance.newBatchInventory(drugId: drugId, unitSellPrice: unitSellPrice, unitSellCurrency: unitSellCurrency, unitBuyPrice: unitBuyPrice, unitBuyCurrency: unitBuyCurrency, unitCount: unitCount.toDouble(), batchDate: batchDate, expiryDate: expiryDate);
